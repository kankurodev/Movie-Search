        ...
        xhr.onload = function() {
            ...
            if (xhr.status === 200) {
                ...
                if (resObj.total_results !== 0) {
                    ...
                    //Display elements that were hidden if previous search returned no results
                    main.style.display = 'inline-block';
                    viewMore.style.display = 'inline-block';
                    mainh2.style.display = 'inline-block';
                    ...
                    if (mainh2[1] === undefined) {
                        main.insertAdjacentHTML('beforebegin', "<h2 class='error'>Error: The movie you requested could not be found! <br>Please try again!</h2>");
                    }
